...
آشنا با برنامه‌های فوتوشاپ، افتر افکتز، ایلوستریتور، تون‌بوم هارمونی، استوری‌برد پرو، پروکرییت و...
              ...
              <p dir="rtl">
              • کارکتر دیزاینر و تصویرساز انتشارات الفبای مهر از ۱۴۰۵ - تا کنون
              <br></br>
              • بکگراند ارتیست گنبد کبود از ۱۴۰۳ - ۱۴۰۴
              <br></br>
• تصویرساز استودیو پارتیکل از ۱۴۰۲ - ۱۴۰۳
              <br></br>
• سابقه ساخت یک‌ اثر کوتاه برای موسسه‌ی محک.  
              <br></br>
• سابقه تصویرسازی هشت قسمت اپیزودیک برای سایت دیوار
              </p>
            </div>
